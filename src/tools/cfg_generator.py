...
class ConfigGenerator:
    def __init__(self, node_ip_range="10.0.0.0/8", path="/tmp"):
        ...
        self.template += "\n"
        self.template += "codes.thread_num_for_decode = 1\n"
        self.template += "codes.outer_code_redundancy = 3\n"
        self.template += "codes.inner_code_redundancy = 3\n"
        self.template += "codes.outer_code_redundancy_for_identity = 0\n"
        self.template += "\n"
